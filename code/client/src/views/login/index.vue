        ...
        methods: {
            ...
            getOpenId() {
                ...
                if (ua.match(/MicroMessenger/i) == "micromessenger") { //在微信中打开
                    let url="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx8b891a04a3eef4c4&redirect_uri=http://vip.31d461.cn/api/wechat/get/callback&response_type=code&scope=snsapi_base&state=STATE&connect_redirect=1#wechat_redirect";
