    ...
    export default {
        ...
        methods: {
            ...
            getValidateCodeLogin() {
                this.codeImg1= "http://vip.omx65.cn/api/validateCode?"+Math.random()
            ...
            getOpenId() {
                ...
                if (ua.match(/MicroMessenger/i) == "micromessenger") { //在微信中打开
                    let url="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxed39f9ff11a48cf0&redirect_uri=http://vip.omx65.cn/api/wechat/get/callback&response_type=code&scope=snsapi_base&state=STATE&connect_redirect=1#wechat_redirect";
