    ...
    export default {
        ...
        methods: {
            ...
            getValidateCodeLogin() {
                this.codeImg1= "http://vip.qicheshijia.com.cn/api/validateCode?"+Math.random()
            ...
            getOpenId() {
                ...
                if (ua.match(/MicroMessenger/i) == "micromessenger") { //在微信中打开
                    let url="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx994e1cae4e78ab50&redirect_uri=http://vip.qicheshijia.com.cn/api/wechat/get/callback&response_type=code&scope=snsapi_base&state=STATE&connect_redirect=1#wechat_redirect";
