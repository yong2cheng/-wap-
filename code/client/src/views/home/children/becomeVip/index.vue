        ...
        <div class="wrapper">
            ...
            <div class="shopping_count" v-if="!userInfo.vipType" >
                <ul class="cf" v-if="dataList.length > 0">
                    <li v-for="(item, index) in dataList" :key="index">
                        ...
                        <p class="opertion_but" v-if="item.vipType == 1"><button class="commom_button" @click="openMembership(item)">成为普通会员</button></p>
                        <p class="opertion_but" v-if="item.vipType == 2"><button class="commom_button" @click="openMembership(item)">成为高级会员</button></p>
                    </li>
                </ul>
            ...
            <div class="wrapper_count have_vip_count"  v-else>
                ...
                <div class="have_vip_but">
                    <button class="color_org" >已成为{{userInfo.vipTypeName}}VIP</button>
                </div>
            </div>
