        ...
        <div class="task_detail_wrapper">
            ...
            <div class="task_detail_count" >
                ...
                <div class="task_detail_derc">
                    ...
                    <img :src="'http://vip.qicheshijia.com.cn/api/'+item" alt="" style="width:96%;height:175px" v-for="(item,index) in this.detailData.taskPicList" :key="index" @click="clickTip"/>
                </div>
                <div class="task_detail_derc" v-if="this.detailData.applyPicList&&this.detailData.applyPicList.length>0">
                    <h4>完成任务上传图片</h4>
                    <img :src="'http://vip.qicheshijia.com.cn/api/'+item" alt="" style="width:96%;height:175px" v-for="(item,index) in this.detailData.applyPicList" :key="index" @click="clickTip"/>
                </div>
