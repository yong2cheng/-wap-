<template>
    <el-dialog title="积分兑换详情" :visible.sync="dialogTableVisible" class="edit-wrapper" @close="close" width="50%" center>
        <el-form ref="form" label-width="100px" class="form">
            ...
            <el-form-item label="商品图片" prop="isVisible" class="left-item">
                <img :src="'http://vip.yuziyule.cn/api/'+info.goodsPic" alt="" style="width:100px;height:50px" @click="clickImg($event)">
            </el-form-item>
